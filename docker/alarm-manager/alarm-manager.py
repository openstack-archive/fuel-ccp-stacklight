...
dflt_config = os.path.join(dflt_cfg_dir, 'config/alarm-manager.ini')
dflt_template = os.path.join(dflt_cfg_dir, 'templates/lua_alarming_template.j2')
dflt_cfg_template = os.path.join(dflt_cfg_dir, 'templates/alert_manager_lua_config_template.cfg.j2')
