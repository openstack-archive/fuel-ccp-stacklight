...
local vswitchd_grammar = l.Ct(p_timestamp * l.S("T") * p_date * l.S("Z") * pipe * p_id * pipe * p_module * p_severity_label * pipe * p_message)


function process_message ()
    local log = read_message("Payload")
    local logger = "ovs_vswitchd"

    local m = vswitchd_grammar:match(log)
