...
local function get_node_ip_address(node_name)
...
if not kubelet_stats_host then
    ...
    assert(node_name, 'CCP_HINDSIGHT_NODE_NAME environment variable not defined')
    local err_msg
    kubelet_stats_host, err_msg = get_node_ip_address(node_name)
