...
git fetch https://github.com/obourdon/snap-plugin-collector-disk ${REFSPEC}
git checkout FETCH_HEAD
#git checkout ${REFSPEC}
make deps
...
REFSPEC="3a4e37c4921ea005d0668f407d51d6e770600e8b"
...
REFSPEC="a7aa92d2a72ebf595c1309ea18c1f697981b318a"
...
# Build Snap
REFSPEC="4c9dc9fc91e2f024eb8f4d3aaccad574fd06700f"
